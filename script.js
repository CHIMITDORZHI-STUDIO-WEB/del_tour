...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ========================================
    // 3. Обработка формы — отправка через FormSubmit (AJAX)
    // ========================================
    ...
    if (form && submitBtn) {
        form.addEventListener('submit', async (e) => {
            ...
            submitBtn.innerHTML = '<span class="material-icons">hourglass_top</span> Отправляем...';
            ...
            try {
                ...
                submitBtn.innerHTML = '<span class="material-icons">error</span> Ошибка, попробуйте позже';
